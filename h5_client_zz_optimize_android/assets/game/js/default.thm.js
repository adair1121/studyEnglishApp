window.skins={};
	...
	function SingleWordSelectItemSkin() {
		_super.call(this);
		this.skinParts = ["rect","font","checkbox","wrongImg"];
		
		this.height = 57;
		this.width = 300;
		this.elementsContent = [this._Image1_i(),this.rect_i(),this.font_i(),this.checkbox_i(),this.wrongImg_i()];
	}
	...
	function warnFrameSkin() {
		_super.call(this);
		this.skinParts = ["maskRect","sureBtn","cancleBtn","tips"];
		...
		this.states = [
			...
			new eui.State ("select",
				[
					new eui.AddItems("cancleBtn","_Group1",2,"_Image4"),
					new eui.SetProperty("sureBtn","horizontalCenter",-103.5),
					new eui.SetProperty("sureBtn","bottom",19)
				])
		];
	}
	...
	_proto._Group1_i = function () {
		...
		t.touchThrough = true;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this.sureBtn_i(),this._Image4_i(),this._Label3_i(),this.tips_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
...
})(eui.Skin);generateEUI.paths['resource/skins/ReadSceneSkin.exml'] = window.ReadSceneSkin = (function (_super) {
	__extends(ReadSceneSkin, _super);
	function ReadSceneSkin() {
		_super.call(this);
		this.skinParts = ["title","exitButton","viewGroup","scroller","txtInput","nextBtn","submitBtn","correctLab"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.title_i(),this.exitButton_i(),this.scroller_i(),this._Label1_i(),this.txtInput_i(),this.nextBtn_i(),this.submitBtn_i(),this.correctLab_i()];
	}
	var _proto = ReadSceneSkin.prototype;
	...
	function SingleWordSelectSkin() {
		_super.call(this);
		this.skinParts = ["exitButton","buttonLabel","sureBtn","delBtn","list","scroller","title","selectCheck","selectAll","checkRecordLab"];
	...
	_proto._Group1_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.exitButton_i(),this.sureBtn_i(),this.delBtn_i(),this.scroller_i(),this.title_i(),this.selectAll_i(),this.checkRecordLab_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.checkRecordLab_i = function () {
		var t = new eui.Label();
		this.checkRecordLab = t;
		t.anchorOffsetX = 0;
		t.bottom = 179;
		t.horizontalCenter = 0;
		t.text = "已检查0个/错误0个/正确率100%";
		t.textAlign = "center";
		t.textColor = 0x6b6565;
		t.verticalAlign = "middle";
		t.visible = false;
		t.width = 545;
		return t;
	...
	function WordLibLevelSelectSkin() {
		_super.call(this);
		this.skinParts = ["exitButton","list","scroller","list1","scroller1","sureBtn","list2","scroller2","sureBtn2","curLib","recordNum","remainNum","checkResult","winGoldNum","viewstack","tabbar"];
		...
		this.states = [
			new eui.State ("record",
				[
					new eui.AddItems("viewstack","_Group5",2,"tabbar"),
	...
	_proto._Group3_i = function () {
		...
		t.touchThrough = true;
		t.x = 10;
		t.elementsContent = [this._Label4_i(),this.scroller2_i(),this.sureBtn2_i()];
		return t;
	};
	_proto._Label4_i = function () {
		var t = new eui.Label();
	...
	_proto._Group4_i = function () {
		...
		t.x = 30.03;
		t.y = 124.67;
		t.elementsContent = [this._Label6_i(),this._Image4_i(),this._Label7_i(),this._Label8_i(),this._Label9_i(),this._Label10_i(),this._Label11_i(),this.curLib_i(),this.recordNum_i(),this.remainNum_i(),this.checkResult_i(),this.winGoldNum_i()];
		return t;
	};
	...
	_proto._Image4_i = function () {
		var t = new eui.Image();
		t.anchorOffsetY = 0;
		t.bottom = 418.17999999999995;
		t.left = 0;
		t.right = -0.17999999999994998;
		t.source = "main_white_block_png";
		t.top = 0;
		return t;
	};
