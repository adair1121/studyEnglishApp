class GameLoadingUI extends eui.Group {
	...
	private progressPane:eui.Group;
    // private messageText:eui.Label;
	// private progressBg1:eui.Image;
    private progressBg2:eui.Image;
    // private progressBg3:eui.Image;
    private progress:eui.Image;
    // private progress2:eui.Image;
    // private posImage:eui.Image;

    private progressMask:eui.Rect;
    // private progressMask2:eui.Rect;
    ...
    private static instance:GameLoadingUI;

    public static GetInstance():GameLoadingUI
    {
        if(!this.instance)
        {
    ...
    public setProgress(t: number, e: string, duration?: number):void {
