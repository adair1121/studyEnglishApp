...
class CommonUtils extends BaseClass {
	...
	// 	let str = null;
	// 	if(LanguageCfg.languageType == "en"){
	// 		return this.lengthEnChange(num);
	// 	}
	...
	// 		str = num + LanguageCfg.getLanguage(1126);
	// 	}
	// 	else {
	// 		num = (num / 10000);
	// 		num = Math.floor(num * 10) / 10;
	// 		str = num + LanguageCfg.getLanguage(1124);
	// 	}
	// 	return str;
	// }
	// private static lengthEnChange(num:number):string{
	// 	let str = null;
	// 	if(num < 1000){
	// 		str = Math.floor(num) + "";
	// 	}else if(num < 1000000){
	// 		num = (num/1000);
	// 		num = Math.floor(num * 10) / 10;
	// 		str = num + LanguageCfg.getLanguage(1123);
	// 	}else if(num < 1000000000){
	// 		num = (num/1000000);
	// 		num = Math.floor(num * 10) / 10;
	// 		str = num + LanguageCfg.getLanguage(1125);
	// 	}else{
	// 		num = (num/1000000000);
	// 		num = Math.floor(num * 10) / 10;
	// 		str = num + LanguageCfg.getLanguage(1127);
	// 	}
	// 	return str;
	// }
