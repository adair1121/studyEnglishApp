class ViewManager extends BaseClass {
	...
	public constructor() {
		...
		this._constView = ["GameSceneView", "UIView2", "TipsView", "PlayFunView"];
	}
	...
	private filters: Array<string> = ["TipsView", "UIView1_1", "GameSceneView", "PlayFunView"];
	 ...
	 * @param param 打开窗口传入的参数
	 *  */
	public openExture(nameOrClass: any, ...param: any[]): BaseEuiView {
		let key = this.getKey(nameOrClass);
